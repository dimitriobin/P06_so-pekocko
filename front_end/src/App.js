...
function App() {
  return (
    <div className="App">
      ...
      <footer className="bg-gray-900 text-white w-full p-10 flex flex-wrap justify-evenly items-center">
        <p className="my-1">Copyright 2021</p>
        <a className="underline my-1" href="dimitriobin.com">dimitriobin.com</a>
        <a className="underline my-1" href="mailto:dimitriobin@gmail.com">Reach me out here</a>
      </footer>
    </div>
  );
}
